...
describe('Central de Atendimento ao Cliente TAT', function () {
  ...
  it('valida se campo telefone continua vazio digitando um valor não-numérico.', function () {
    cy.get('input[name="firstName"]').type('Laura')
    cy.get('input[name="lastName"]').type('Rosa')
    cy.get('#email').type('laurabeatriz.or@gmail.com')
    cy.get('#phone').type('aaaaaa').should('have.value', '')
    cy.get('textarea[name="open-text-area"]').type('teste')
    cy.contains('button', 'Enviar').click()
    cy.get('.success').should('be.visible')
  })
  ...
  it('preenche e limpa os campos nome, sobrenome, email e telefone', function () {
    ...
    cy.get('input[name="lastName"]')
      ...
      .should('have.value', '')
    cy.get('#email')
      .type('laurabeatriz.or@gmail.com')
      .should('have.value', 'laurabeatriz.or@gmail.com')
      .clear()
      .should('have.value', '')
    cy.get('#phone')
      .type('51123456789')
      .should('have.value', '51123456789')
      .clear()
      .should('have.value', '')
